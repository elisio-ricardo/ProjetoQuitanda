...
public class ClasseCarrinho {
	...
	public CarrinhoCompras[] SomarValoresFrutas(CarrinhoCompras[] lista, int i, int opc) {
		...
		public CarrinhoCompras[] SomarValoresverLeg(CarrinhoCompras[] lista, int i, int opc) {
			//Criei essa classe para a classe metodos não ficar com tanta informação
